var size = 0;
var placement = 'point';
function categories_streetcardisp(feature, value, size, resolution, labelText,
...
var style_streetcardisp = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_streetcardisp(feature, value, size, resolution, labelText,
