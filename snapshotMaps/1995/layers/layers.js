...
var group_1995 = new ol.layer.Group({
...
lyr_OpenStreetmap.setVisible(true);lyr_Roads.setVisible(true);lyr_MissingRoads.setVisible(true);
var layersList = [group_Maps,group_1995];
