...
var format_19201950MissingRoads_13 = new ol.format.GeoJSON();
var features_19201950MissingRoads_13 = format_19201950MissingRoads_13.readFeatures(json_19201950MissingRoads_13, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_19201950MissingRoads_13 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_19201950MissingRoads_13.addFeatures(features_19201950MissingRoads_13);
var lyr_19201950MissingRoads_13 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_19201950MissingRoads_13, 
                style: style_19201950MissingRoads_13,
                popuplayertitle: '1920-1950 Missing Roads',
                interactive: true,
                title: '<img src="styles/legend/19201950MissingRoads_13.png" /> 1920-1950 Missing Roads'
            });
var format_19201950Roads_14 = new ol.format.GeoJSON();
var features_19201950Roads_14 = format_19201950Roads_14.readFeatures(json_19201950Roads_14, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_19201950Roads_14 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_19201950Roads_14.addFeatures(features_19201950Roads_14);
var lyr_19201950Roads_14 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_19201950Roads_14, 
                style: style_19201950Roads_14,
                popuplayertitle: '1920-1950 Roads',
                interactive: true,
                title: '<img src="styles/legend/19201950Roads_14.png" /> 1920-1950 Roads'
            });
var format_19501980Roads_15 = new ol.format.GeoJSON();
var features_19501980Roads_15 = format_19501980Roads_15.readFeatures(json_19501980Roads_15, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_19501980Roads_15 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_19501980Roads_15.addFeatures(features_19501980Roads_15);
var lyr_19501980Roads_15 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_19501980Roads_15, 
                style: style_19501980Roads_15,
                popuplayertitle: '1950-1980 Roads',
                interactive: true,
                title: '<img src="styles/legend/19501980Roads_15.png" /> 1950-1980 Roads'
            });
...
var group_RoadsandRail = new ol.layer.Group({
                                layers: [lyr_Pre1800MissingRoads_1,lyr_Sevensisters_2,lyr_Pre1800Roads_3,lyr_18001860MissingRoads_4,lyr_18001860Roads_5,lyr_18601880MissingRoads_6,lyr_18801900MissingRoads_7,lyr_18801900Roads_8,lyr_19001910Roads_9,lyr_19001910MissingRoads_10,lyr_19101920Roads_11,lyr_19101920MissingRoads_12,lyr_19201950MissingRoads_13,lyr_19201950Roads_14,lyr_19501980Roads_15,lyr_Pointsofinterest_16,],
                                fold: 'open',
...
lyr_OpenStreetmap_0.setVisible(true);lyr_Pre1800MissingRoads_1.setVisible(true);lyr_Sevensisters_2.setVisible(true);lyr_Pre1800Roads_3.setVisible(true);lyr_18001860MissingRoads_4.setVisible(true);lyr_18001860Roads_5.setVisible(true);lyr_18601880MissingRoads_6.setVisible(true);lyr_18801900MissingRoads_7.setVisible(true);lyr_18801900Roads_8.setVisible(true);lyr_19001910Roads_9.setVisible(true);lyr_19001910MissingRoads_10.setVisible(true);lyr_19101920Roads_11.setVisible(true);lyr_19101920MissingRoads_12.setVisible(true);lyr_19201950MissingRoads_13.setVisible(true);lyr_19201950Roads_14.setVisible(true);lyr_19501980Roads_15.setVisible(true);lyr_Pointsofinterest_16.setVisible(true);
...
lyr_19201950MissingRoads_13.set('fieldAliases', {'First Seen': 'First Seen', 'Name': 'Name', 'Last Seen': 'Last Seen', });
lyr_19201950Roads_14.set('fieldAliases', {'First Seen': 'First Seen', 'Name': 'Name', });
lyr_19501980Roads_15.set('fieldAliases', {'First Seen': 'First Seen', 'Name': 'Name', });
...
lyr_19201950MissingRoads_13.set('fieldImages', {'First Seen': 'TextEdit', 'Name': 'TextEdit', 'Last Seen': 'TextEdit', });
lyr_19201950Roads_14.set('fieldImages', {'First Seen': 'TextEdit', 'Name': 'TextEdit', });
lyr_19501980Roads_15.set('fieldImages', {'First Seen': 'TextEdit', 'Name': 'TextEdit', });
...
lyr_19201950MissingRoads_13.set('fieldLabels', {'First Seen': 'no label', 'Name': 'no label', 'Last Seen': 'no label', });
lyr_19201950Roads_14.set('fieldLabels', {'First Seen': 'no label', 'Name': 'no label', });
lyr_19501980Roads_15.set('fieldLabels', {'First Seen': 'no label', 'Name': 'no label', });
